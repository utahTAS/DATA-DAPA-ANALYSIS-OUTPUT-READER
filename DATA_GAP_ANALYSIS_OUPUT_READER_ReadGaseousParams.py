...
#            if '11/30/2019 22.0 - 1/1/2020' not in text.split('\n')[3] and '11/29/2019 0.0 - 12/31/2019' not in text.split('\n')[3]:
            params=['6810{}'.format(x) for x in range(10)]
            params.extend(['88101','85101','81102','88313'])
            if not any(param in text for param in params):
                text_all+=text
#%%
...
text_file = open(directory+'/'+"summary_of_year_end_review_gaseous.txt", "wt")
